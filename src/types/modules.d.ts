...
declare module 'culori' {
  ...
  export function converter(mode: 'lab'): (color: Color | string) => Lab | undefined;
  export function converter(mode: 'rgb'): (color: Color | string) => Rgb | undefined;
  export function converter(mode: 'hsl'): (color: Color | string) => Hsl | undefined;
